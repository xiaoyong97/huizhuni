                        ...
                        <div class="list_div ">
                            ...
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                ...
                                <van-col  class="" span="17" >
                                    <p class="list_text2">已抢单客户<span>广州可可里服装有限公司</span>产品额度发生变化，请查看</p>
                                </van-col>
                            ...
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                ...
                                <van-col  class="" span="2" v-show="delete_status==false"> <div class="read_status_div"></div></van-col>
                                <van-col  class="" span="17" >
                                    <p class="list_text2">已抢单客户<span>广州清竹洒业有限公司</span>商机已失效，请查看</p>
                                </van-col>
                                <van-col  class="" span="5" style="text-align: right"><p class="list_text_time">13:36</p></van-col>
                            </van-row>
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                <van-col  class="" span="2" v-show="delete_status==true"><van-checkbox class="check_box" checked-color="#4c62e7" v-model="result"></van-checkbox></van-col>
                                <van-col  class="" span="2" v-show="delete_status==false"> <div class=" "></div></van-col>
                                <van-col  class="" span="17" >
                                    <p class="list_text2 gray_text">已抢单客户<span class="gray_text">尚佛友文化传播有限公司</span>商机已失效，请查看</p>
                                </van-col>
                            ...
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                ...
                                <van-col  class="" span="2" v-show="delete_status==false"> <div class="read_status_div"></div></van-col>
                                <van-col  class="" span="17" >
                                    <p class="list_text2">已抢单客户<span>乐田文化传媒有限公司</span>产品颜度发生变化，请点击查看</p>
                                </van-col>
                            ...
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                ...
                                <van-col  class="" span="2" v-show="delete_status==false"> <div class=" "></div></van-col>
                                <van-col  class="" span="17" >
                                    <p class="list_text2 gray_text">已抢单客户<span class="gray_text">广州佳人有约直指平台有限公司</span>产品额度发生变化，请意看</p>
                                </van-col>
                            ...
                            <van-row class="list_box" type="flex" justify="center" style="position: relative">
                                ...
                                <van-col  class="" span="2" v-show="delete_status==false"> <div class=" "></div></van-col>
                                <van-col  class="" span="17" >
                                    <p class="list_text2 gray_text">已抢单客户<span class="gray_text">4399游戏平台网络有限公司</span>商机已失效，请查看</p>
