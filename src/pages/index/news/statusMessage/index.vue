    ...
    export default {
        ...
        data (){
            return {
                ...
                list:[
                    {checkbox_status:false,delete_status:false,result:0,read:false,text1:'已抢单客户',text2:'广州可可里服装有限公司',text3:'产品额度发生变化，请查看',text4:'14:20',},
                    {checkbox_status:false,delete_status:false,result:0,read:false,text1:'已抢单客户',text2:'广州清竹酒业有限公司',text3:'商机已失效，请查看',text4:'13:36',},
                    {checkbox_status:false,delete_status:false,result:0,read:true,text1:'已抢单客户',text2:'尚佛友文化传播有限公司',text3:'商机已失效，请查看',text4:'昨天',},
                    {checkbox_status:false,delete_status:false,result:0,read:false,text1:'已抢单客户',text2:'乐田文化传媒有限公司',text3:'产品额度发生变化，请查看',text4:'2018/08/21',},
                    {checkbox_status:false,delete_status:false,result:0,read:true,text1:'已抢单客户',text2:'4399游戏平台网络有限公司',text3:'产品额度发生变化，请查看',text4:'2018/08/21',},
                    {checkbox_status:false,delete_status:false,result:0,read:true,text1:'已抢单客户',text2:'广州佳人有约直播平台有限公司',text3:'商机已失效，请查看',text4:'2018/08/15',},
                ],
            }
        },
