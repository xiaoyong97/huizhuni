            ...
            <van-tabs color="#4c62e7" line-width="50%" line-height=3>
                <van-tab title="待补录" color="#4c62e7">
                    <div class="card_div" style="">
                        ...
                        <van-row style="text-align: center;padding: 8px 12px 8PX;border-top: #dddddd 1px solid" type="flex" justify="center" @click="go('collectOperation')">
