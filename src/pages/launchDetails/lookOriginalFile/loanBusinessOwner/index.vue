			...
			<van-cell-group class="bg-grey"  >
				<div >
					<van-cell>
						 ...
						 <van-col span="23"><h3>企业信息</h3></van-col>
					</van-cell>
					<van-cell>
						 <van-col span="10">企业营业执照:</van-col>
						 <van-col span="12"><img class="yyzz" src="../../../../assets/images/other/yyzz.png" alt=""></van-col>
					</van-cell>
					<van-cell>
...
//数据预加载
 created() {
  ...
  computed: {
	 title :function  () {
			var type = localStorage.getItem('ckywj_type');
