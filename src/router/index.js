...
export default new Router({
    ...
    routes: [
      ...
      {
        name: 'xiaoNewActivitiesConfirmDetails',
        path: '/offlineHuoDong/xiaoNewActivitiesConfirmDetails',
        component: () => import('@/pages/offlineHuoDong/xiaoNewActivitiesConfirmDetails'),
        meta: {
        title: '小微活动详情'
        },
      },
